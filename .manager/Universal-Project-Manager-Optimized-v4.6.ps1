...
.EXAMPLE
  pwsh -File .\.manager\Universal-Project-Manager-Optimized-v4.6.ps1 -Action status -Performance -AI -Verbose
  pwsh -File .\.manager\Universal-Project-Manager-Optimized-v4.6.ps1 -Action analyze -Category ai -AI -Verbose
  pwsh -File .\.manager\Universal-Project-Manager-Optimized-v4.6.ps1 -Action optimize -Performance -AI -Verbose
...
function Show-ManagerHelp {
    ...
    Write-Host "  pwsh -File .\.manager\Universal-Project-Manager-Optimized-v4.6.ps1 -Action status -Performance -AI -Verbose" -ForegroundColor White
    Write-Host "  pwsh -File .\.manager\Universal-Project-Manager-Optimized-v4.6.ps1 -Action analyze -Category ai -AI -Verbose" -ForegroundColor White
    Write-Host "  pwsh -File .\.manager\Universal-Project-Manager-Optimized-v4.6.ps1 -Action optimize -Performance -AI -Quantum" -ForegroundColor White
}
