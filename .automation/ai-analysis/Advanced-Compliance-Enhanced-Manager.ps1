# Advanced Compliance Enhanced Manager v2.9
...
function Show-Header {
    Write-ColorOutput "`n🔒 Advanced Compliance Enhanced Manager v2.9" -Color "Header"
...
function Show-Help {
    Show-Header
    Write-ColorOutput "`nUsage: .\Advanced-Compliance-Enhanced-Manager.ps1 [options]" -Color "Info"
    ...
    Write-ColorOutput "  .\Advanced-Compliance-Enhanced-Manager.ps1 -Install" -Color "Info"
    Write-ColorOutput "  .\Advanced-Compliance-Enhanced-Manager.ps1 -Action start -Port 3000" -Color "Info"
    Write-ColorOutput "  .\Advanced-Compliance-Enhanced-Manager.ps1 -Cluster -Workers 4" -Color "Info"
    Write-ColorOutput "  .\Advanced-Compliance-Enhanced-Manager.ps1 -RunAssessment -Framework gdpr" -Color "Info"
    Write-ColorOutput "  .\Advanced-Compliance-Enhanced-Manager.ps1 -Status" -Color "Info"
}
...
function Test-Prerequisites {
    ...
    $compliancePath = "..\..\advanced-compliance-enhanced-v2.9"
    if (-not (Test-Path $compliancePath)) {
        Write-ColorOutput "❌ Compliance directory not found: $compliancePath" -Color "Error"
        return $false
    }
    
    Write-ColorOutput "✅ Compliance directory found" -Color "Success"
...
switch ($Action.ToLower()) {
    "install" {
        if (Install-Compliance) {
            ...
            Write-ColorOutput "Run '.\Advanced-Compliance-Enhanced-Manager.ps1 -Action start' to start the compliance engine" -Color "Info"
        } else {
